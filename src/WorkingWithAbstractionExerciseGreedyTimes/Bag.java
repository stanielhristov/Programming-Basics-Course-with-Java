package WorkingWithAbstractionExerciseGreedyTimes;

import java.util.*;

import static WorkingWithAbstractionExerciseGreedyTimes.Type.*;


public class Bag {
    private List<WorkingWithAbstractionExerciseGreedyTimes.Item> items;
